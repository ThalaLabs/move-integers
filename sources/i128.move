module move_int::i128 {
    ...
    public fun from(v: u128): I128 {
        assert!(v <= BITS_MAX_I128, OVERFLOW);
        I128 { bits: v }
    }
    ...
    public fun neg_from(v: u128): I128 {
        assert!(v <= BITS_MIN_I128, OVERFLOW);
    ...
    public fun mul(num1: I128, num2: I128): I128 {
        ...
        if (sign(num1) != sign(num2)) {
            assert!(product <= (BITS_MIN_I128 as u256), OVERFLOW);
            neg_from((product as u128))
        } else {
            assert!(product <= (BITS_MAX_I128 as u256), OVERFLOW);
    ...
    public fun abs(v: I128): I128 {
        let bits = if (sign(v) == 0) { v.bits }
            ...
            assert!(v.bits > BITS_MIN_I128, OVERFLOW);
