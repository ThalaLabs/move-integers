spec move_int::i128 {
    ...
    spec fun spec_add(num1: I128, num2: I128): I128 {
    ...
    spec fun spec_sub(num1: I128, num2: I128): I128 {
        spec_add(num1, I128 { bits: twos_complement(num2.bits) })
    }
    ...
    spec fun spec_mod(num1: I128, num2: I128): I128 {
